...
Job5 starts after all the array jobs from job4 have been finished due to the defined dependency.
...
do
	...
	bwa index -p ./xargs_results/${file_no_path%.*} $file 2>/dev/null;
done
...
Compared runtimes can be found at ./runtimes.PNG
